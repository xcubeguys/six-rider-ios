...
public class CreditCardFormView : UIView {
    ...
    private func createCardHolderText() {
        ...
        cardHolderText.font = UIFont(name: "Helvetica Neue", size: 20)
        cardHolderText.text = cardHolderPlaceholderString
        cardHolderText.textColor = cardHolderExpireDateTextColor
        frontView.addSubview(cardHolderText)
        
        self.addConstraint(NSLayoutConstraint(item: cardHolderText, attribute: NSLayoutAttribute.bottom, relatedBy: NSLayoutRelation.equal, toItem: cardHolder, attribute: NSLayoutAttribute.top, multiplier: 5.0, constant: -5));
        
        self.addConstraint(NSLayoutConstraint(item: cardHolderText, attribute: NSLayoutAttribute.leading, relatedBy: NSLayoutRelation.greaterThanOrEqual , toItem: cardView, attribute: NSLayoutAttribute.leading, multiplier: 5.0, constant: 40));
    }
