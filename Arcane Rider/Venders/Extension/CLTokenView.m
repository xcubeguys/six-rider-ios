...
- (id)initWithToken:(CLToken *)token font:(nullable UIFont *)font
{
    ...
    if (self) {
        UIColor *tintColor = [UIColor colorWithRed:43.0 green:32.0 blue:12.0 alpha:1.0];
...
- (void)layoutSubviews
{
    ...
    self.label.backgroundColor = [UIColor colorWithRed:44.0/255.0 green:32.0/255.0 blue:12.0/255.0 alpha:1.0];
}
